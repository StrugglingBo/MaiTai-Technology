...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(linkurl("integral_list",""+model.category_id));
	...
	templateBuilder.Append("</div>\r\n                <div class=\"price\">\r\n                    <span class=\"label\">单价</span><span class=\"value\">￥" + Utils.ObjectToStr(model.fields["sell_price"]) + "+" + Utils.ObjectToStr(model.fields["point"]) + "麦币</span></div>\r\n                <div class=\"tb\" id=\"selectTb\">\r\n                    <span class=\"label\">数量</span><span class=\"value\"><i class=\"amount\"><b class=\"reduce\">-</b><input\r\n                        id=\"commoditySelectNum\" maxlength=\"9\" value=\"1\" maxvalue=\"" + Utils.ObjectToStr(model.fields["stock_quantity"]) + "\"\r\n                        onkeydown=\"return checkNumber(event);\" type=\"text\" class=\"number\" /><b class=\"increase\">+</b></i></span><i class=\"kc\">库存：" + Utils.ObjectToStr(model.fields["stock_quantity"]) + "</i>\r\n                </div>\r\n                ");
