...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="16%">会员组</th>
    <th align="left" width="12%">手机号码</th>
    <th width="8%">今日积分</th>
    <th width="8%">可用积分</th>
    <th width="8%">状态</th>
    <th width="8%">操作</th>
...
<ItemTemplate>
  <tr>
    ...
    <td>
      <div class="user-box">
        <h4><b><%#Eval("user_name")%></b> (推荐人：<%#Eval("nick_name")%>)</h4>
    ...
    <td><%#new DTcms.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%>[<%#Eval("area")%>]</td>
    <td><%#Eval("mobile")%></td>
