<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="applor_order_edit.aspx.cs" Inherits="DTcms.Web.admin.order.applor_order_edit" ValidateRequest="false" %>
...
<div class="location">
  ...
  <i class="arrow"></i>
  <a href="applor_order_list.aspx"><span>供应商订单管理</span></a>
  <i class="arrow"></i>
  <span>订单详细</span>
</div>
...
<div class="page-footer">
  <div class="btn-wrap">
    <input id="btnConfirm" runat="server" visible="false" type="button" value="确认订单" class="btn"   style="display:none;"/>
    <input id="btnPayment" runat="server" visible="false" type="button" value="确认付款" class="btn"  style="display:none;" />
    ...
    <input id="btnInvalid" runat="server" visible="false" type="button" value="作废订单" class="btn green"  style="display:none;" />
