            ...
            <div class="box-wrap">
                ...
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li>
                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','只允许删除已作废订单，是否继续？');"
                                OnClick="btnDelete_Click"><i></i><span>删除</span></asp:LinkButton></li>
                                <li><asp:LinkButton ID="btnexport" runat="server" CssClass="save" onclick="btnexport_Click"><i></i><span>导出异常订单</span></asp:LinkButton></li>
                    </ul>
                    <div class="menu-list">
                        ...
                        <div class="rule-single-select">
                            <asp:DropDownList ID="ddlpaymenttype" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlpaymenttype_SelectedIndexChanged">
                                ...
                                <asp:ListItem Value="6">支付宝支付</asp:ListItem>
                                <asp:ListItem Value="7">微信支付</asp:ListItem>
                                <asp:ListItem Value="8">网银在线</asp:ListItem>
                                <asp:ListItem Value="9">京东支付</asp:ListItem>
                                <asp:ListItem Value="10">百度钱包</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="rule-single-select">
    ...
    <div class="table-container">
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    <td align="center">
                        <asp:CheckBox ID="chkId" CssClass="checkall" runat="server" Enabled='<%#bool.Parse((Convert.ToInt32(Eval("status")) > 3 ).ToString())%>'
                            Style="vertical-align: middle;" />
                        <asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" />
                    </td>
                    <td>
                        <a href="order_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                            <%#Eval("order_no")%></a>
                    </td>
                    <td>
                    ...
                    <td>
                        <%#new DTcms.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%>
                    </td>
                    <td align="center">
                    ...
                    <td align="center">
                        <a href="order_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">详细</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
