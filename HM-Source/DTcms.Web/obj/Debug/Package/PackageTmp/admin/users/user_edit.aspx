...
<head>
    ...
    <link href="/templates/maimaigo/css/city-picker.css" rel="stylesheet" type="text/css" />
    ...
    <script src="/templates/maimaigo/js/city-picker.data.js"></script>
    <script src="/templates/maimaigo/js/city-picker.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //初始化地区
            var $citypicker3 = $('#city_picker3');
            var pp = "";
            var ct = "";
            var dt = "";
            var addr = $("#txtarea").val();
            var arr = addr.split(',');
            pp = arr[0];
            ct = arr[1];
            dt = arr[2];
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="user_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="user_list.aspx">
                <span>会员管理</span></a> <i class="arrow"></i><span>编辑会员</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
        ...
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    ...
                    <li><a href="javascript:;">实名认证信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-select">
                    <asp:DropDownList ID="ddlGroupId" runat="server" datatype="*" errormsg="请选择组别" sucmsg=" ">
                    </asp:DropDownList>
                </div>
            </dd>
        </dl>
        ...
        <dl>
            <dt>用户名</dt>
            <dd>
                <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" datatype="*2-100"
                    sucmsg=" " ajaxurl="../../tools/admin_ajax.ashx?action=username_validate"></asp:TextBox>
        ...
        <dl>
            <dt>VIP到期时间</dt>
            <dd>
                <asp:TextBox ID="txtBirthday" runat="server" CssClass="input rule-date-input" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"
        ...
        <dl style="display: none;">
            <dt>MSN</dt>
            <dd>
                <asp:TextBox ID="txtMsn" runat="server" CssClass="input normal"></asp:TextBox></dd>
        </dl>
        <dl style="display: none;">
            <dt>通讯地址</dt>
            <dd>
        ...
        <dl style="display: none;">
            <dt>所属区域</dt>
            <dd>
                <asp:TextBox ID="txtarea" runat="server" CssClass="input normal"></asp:TextBox>
                <span class="Validform_checktip">*以,隔开.例如:浙江省,杭州市,西湖区</span></dd>
        </dl>
        <dl>
            <dt>所属区域</dt>
            <dd>
                <asp:TextBox ID="city_picker3" runat="server" data-toggle="city-picker3" CssClass="input normal"></asp:TextBox></dd>
        </dl>
    </div>
    <div class="tab-content" style="display: none;">
        <dl>
            ...
            <dd>
                ...
                元 <span class="Validform_checktip">*今日获得的积分</span>
            </dd>
        </dl>
        <dl>
            <dt>可用积分</dt>
    ...
    <div class="tab-content" style="display: none;">
        <dl>
            <dt>银行卡号</dt>
            <dd>
                <asp:TextBox ID="txtcardno" runat="server" CssClass="input normal"></asp:TextBox>
            </dd>
        </dl>
        <dl>
            <dt>所属银行</dt>
        ...
        <dl>
            <dt>身份证号</dt>
            <dd>
                <asp:TextBox ID="txtidentyno" runat="server" CssClass="input normal"></asp:TextBox>
            </dd>
        </dl>
        <dl>
            <dt>真实姓名</dt>
            <dd>
                <asp:TextBox ID="txttruename" runat="server" CssClass="input normal"></asp:TextBox>
            </dd>
        </dl>
        <dl>
            <dt>开户行名</dt>
            <dd>
                <asp:TextBox ID="txtalipaynickname" runat="server" CssClass="input normal"></asp:TextBox>
            </dd>
        </dl>
        <dl style="display:none;">
            <dt>支付宝名</dt>
            <dd>
                <asp:TextBox ID="txtalipayaccount" runat="server" CssClass="input normal"></asp:TextBox>
            </dd>
        </dl>
    </div>
    <!--/内容-->
