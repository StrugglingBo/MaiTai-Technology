...
namespace DTcms.DAL
{
    ...
    public partial class user_point_log
    {
        ...
        public bool Delete(int id)
        {
            ...
            string strsql = "update dt_users set point=point-(select value from dt_user_point_log where id=" + id + ") where user_name=(select user_name from dt_user_point_log where id=" + id + ")";
