...
namespace DTcms.BLL
{
    ...
    public partial class users
    {
        ...
        {
            return dal.gettodayuser(area);
        }
        public string gettotalguser(string area)
        {
            return dal.gettotalguser(area);
        }
        public string gettotalpuser(string area)
        {
            return dal.gettotalpuser(area);
        }
        /// <summary>
        /// 根据用户名取得Salt
        /// </summary>
