<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="applor_orders_list.aspx.cs" Inherits="DTcms.Web.admin.order.applor_orders_list" %>
    ...
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          ...
          <li style="display:none;"><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','只允许删除已作废订单，是否继续？');" onclick="btnDelete_Click"><i></i><span>删除</span></asp:LinkButton></li>
           <li><asp:LinkButton ID="btnexport" runat="server" CssClass="save" onclick="btnexport_Click"><i></i><span>导出</span></asp:LinkButton></li>
        </ul>
        <div class="menu-list">
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="applor_order_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">详细</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
...
<tr>
    <th colspan="8" align="right"><asp:FileUpload ID="excleupload" runat="server" /></th>
    <th colspan="1" align="center"><asp:LinkButton ID="btnupload" runat="server"  Text="批量发货" onclick="btnupload_Click" /></th>
</tr>
</table>
</div>
<!--/列表-->
