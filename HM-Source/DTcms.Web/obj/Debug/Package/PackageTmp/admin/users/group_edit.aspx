...
<div class="tab-content">
  ...
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*被推荐人成为vip后,每天所获得的积分数</span>
    </dd>
  </dl>
  <dl>
    <dt>获取下下级积分数：</dt>
    <dd>
      ...
      <span class="Validform_checktip">*下下级成为vip后,每天所获得的积分数</span>
    </dd>
  </dl>
  <dl style="display:none;">
    <dt>初始金额：</dt>
  ...
  <dl>
    <dt>持续时间(天)：</dt>
    <dd>
      <asp:TextBox ID="txtPoint" runat="server" CssClass="input small" datatype="/^-?\d+$/" sucmsg=" " Text="365"></asp:TextBox>
      <span class="Validform_checktip">*获得积分所持续的时间周期</span>
    </dd>
  </dl>
  <dl>
    <dt>购物折扣：</dt>
