$(function () {
    ...
    var tcount = 0;
    var cid = $('#cid').val();
    var baseurl = '/api/appfun.ashx?action=getgoodslist&channel_name=goods&category_id=' + cid + '&page_size=10&strwhere=&orderby=&page_index=';
    $.ajax({
        url: baseurl + page,
        type: 'GET',
        dataType: 'json',
        ...
        success: function (data) {
            if (data.success == "true") {
                ...
                for (var i = 0, t; t = data.list[i++]; ) {
                    ...
                    arrText.push('<span class="price">' + t.sell_price + '</span></li>');
                    tcount = t.totalcount;
                    if (10 * page < tcount) {
