            ...
            switch (aModel.type)
            {
                ...
                case 2: //图片
                    if (ds.Tables[0].Rows.Count == 1)
                    {
                        ...
                        /*<div class=\"item active\" style=\"background:url(images/banner01.jpg) top center no-repeat\"><a style=\"display:block;width:100%;height:100%;\" href=\"\"/></div>*/
                        DataRow dr = ds.Tables[0].Rows[0];
                        context.Response.Write("document.write('<div class=\"item active\" style=\"background:url(" + dr["file_path"] + ") top center no-repeat\">')");
                        context.Response.Write("document.write('<a title=\"" + dr["title"] + "\" target=\"" + aModel.target + "\" href=\"" + dr["link_url"] + "\" style=\"display:block;width:100%;height:100%;\">');");
                    ...
                    else
                    {
                        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            {
                                context.Response.Write("document.write('<div class=\"item\" style=\"background:url(" + dr["file_path"] + ") top center no-repeat\">')");
                                context.Response.Write("document.write('<a title=\"" + dr["title"] + "\" target=\"" + aModel.target + "\" href=\"" + dr["link_url"] + "\" style=\"display:block;width:100%;height:100%;\">');");
                                context.Response.Write("document.write('</div>');");
                            }
                        }
